...
sessionstate_person_obj = Person(Person.find_person_data_by_name(st.session_state.aktuelle_versuchsperson))



st.write("Id der Versuchsperson ist: ", Person.find_person_data_by_name(st.session_state.aktuelle_versuchsperson)["id"])
st.write("Alter der Versuchsperson ist: ", Person.calc_age(sessionstate_person_obj))
st.write("Maximale Herzfrequenz der Versuchsperson ist: ", Person.calc_max_hr(sessionstate_person_obj))

st.write("## EKG-Daten der Versuchsperson")

current_egk_data = ekgdata.EKGdata(Person.find_person_data_by_name(st.session_state.aktuelle_versuchsperson)["ekg_tests"][0])
